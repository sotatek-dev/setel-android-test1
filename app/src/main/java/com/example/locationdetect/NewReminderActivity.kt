...
class NewReminderActivity : BaseActivity(), OnMapReadyCallback {
    ...
    private var reminder = Reminder(latLng = null, radius = null, wifiName = "")

    private val wifiManager by lazy {
        applicationContext.getSystemService(Context.WIFI_SERVICE) as WifiManager
    }

    private val wifiBroadcast = object : BroadcastReceiver() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Add new reminder"
    }
    ...
    private fun showConfigureMessageStep() {
        ...
        next.setOnClickListener {
            ...
            reminder.wifiName = message.text.toString()

            if (reminder.wifiName.isNullOrEmpty()) {
